            ...
            <form id="forms_plugins_gmap_related" method="post" action="">
                <div class="modal-body row">
                    <div class=" form-group col-xs-12">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="society_ga" name="society_ga" value="" size="50" />
                        </div>
                    </div>
                    <div class=" form-group col-xs-12">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="country_ga" name="country_ga">
                                ...
                                {foreach $countryTools as $key => $val}
                                    <option value="{#$val.iso#}">{#$val.iso#|ucfirst}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
                    <div class=" form-group col-xs-12">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="city_ga" name="city_ga" value="" size="50" />
                        </div>
                    </div>
                    <div class=" form-group col-xs-12">
                        <label for="postcode_ga" class="col-sm-3 control-label">Code postal :</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="postcode_ga" name="postcode_ga" value="" size="50" />
                        </div>
                    </div>
                    <div class=" form-group col-xs-12">
                        <label for="adress_ga" class="col-sm-3 control-label">Adresse :</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="adress_ga" name="adress_ga" value="" size="50" />
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <label for="link_ga" class="col-sm-3 control-label">Liens :</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="link_ga" name="link_ga" value="" size="50" />
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class=" form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="lat_ga" id="lat_ga" value="" />
                                </div>
                                <div class=" form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <label for="lng_ga">Longitude</label>
                                    <input type="text" class="form-control" name="lng_ga" id="lng_ga" value="" />
                                </div>
                            </div>
                        </div>
                    </div>
