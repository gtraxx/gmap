<form id="forms_plugins_gmap_edit" method="post" action="">
    <p class="form-group">
        ...
        <input type="text" class="form-control" id="name_map" name="name_map" value="{$map.name_map}" size="50" />
    </p>
    <p>
        <label for="content_page" class="inlinelabel">{#label_content#|ucfirst} :</label>
        <textarea name="content_map" id="content_map" class="mceEditor form-control">{$map.content_map}</textarea>
    </p>
    <p>
